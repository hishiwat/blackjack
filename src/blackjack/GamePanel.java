...
public class GamePanel {
    ...
    public void createResultPanel(String result, int chipChange) {
        ...
        // チップ変動
        JLabel chipLabel = new JLabel("Chip change: " + (chipChange >= 0 ? "+" : "") + chipChange,
    ...
    public JPanel getOtherPlayersPanel() {
    ...
    public JButton getContinueYesButton() {
        return continueYesButton;
    }

    public JButton getContinueNoButton() {
        return continueNoButton;
    }
}